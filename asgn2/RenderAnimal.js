...
function drawAnimal() {
     ...
     if (Shift_and_Click) {
          var body = new Cube();
          body.color = Animal_brown;
          //body.color = Animal_white;
     }
     else {
          var body = new Cube();
          body.color = Animal_brown;
     ...
     head.matrix.translate(head_front_coords_x,head_front_coords_y-0.3,head_front_coords_z);
     head.render();
     ...
     if (Shift_and_Click) {
          var ears1 = new Cube();
          ears1.color =[175.0/255,133.0/255,92.0/255, 1];
     ...
     if (Shift_and_Click) {
          var ears2 = new Cube();
          ears2.color =[175.0/255,133.0/255,92.0/255, 1];
     ...
     //frontleftleg.matrix.translate(-2.2, 0.15, -3.0);
     frontleftleg.render();
     ...
     frontrightleg.matrix.translate(1.2, 0.15, -3.0);
     ...
     backrightleg.matrix.translate(1.2, 0.15, 3.0);
     backrightleg.render();
