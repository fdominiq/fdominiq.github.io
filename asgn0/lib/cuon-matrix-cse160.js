...
class Vector3 {
  ...
  static cross(other1, other2) {
      ...
      var vec1 = other1.elements;
      var vec2 = other2.elements;

      v3.elements[0] =   (vec1[1]*vec2[2]) - (vec1[2]*vec2[1]);
      v3.elements[1] =  -(vec1[0]*vec2[2]) + (vec1[2]*vec2[0]);
      v3.elements[2] =   (vec1[0]*vec2[1]) - (vec1[1]*vec2[0]);
